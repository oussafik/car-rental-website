...
<br>
  ...
  <br>
  <img class="right" src="image/vehicle-3.png" >
  <br>
  <h1 class="h"> 
    Ferrari 812
    <sub id="sub"></sub><br></h1>
...
<p class="para">The Ferrari 812 has 1 Petrol Engine on offer. The Petrol engine is 6496 cc. 
  It is available with Automatic transmission.Depending upon the variant and fuel type the 812 has a mileage of 6.1 kmpl. 
  The 812 is a 2 seater 8 cylinder car and has length of 4693mm, width of 1971mm and a wheelbase of 2720mm.
</p></section>
<section>
<h1 class="h1"> Key Specifications of Ferrari 812: </h1>
<p class="para"><br>
    <img class="right2" src="image/features-vehicle-3.png" >
    <p class="para"><br>
