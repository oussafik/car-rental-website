...
<br>
  ...
  <br>
  <img class="right" src="image/vehicle-4.png" >
  <br>
  <h1 class="h"> 
    Ferrari F8 Tributo
    <sub id="sub"></sub><br></h1>
...
<p class="para">The Ferrari F8 Tributo has 1 Petrol Engine on offer. The Petrol engine is 3902 cc. 
  It is available with Automatic transmission.Depending upon the variant and fuel type the F8 Tributo has a mileage of 7.75 kmpl. 
  The F8 Tributo is a 2 seater 8 cylinder car and has length of 4611, width of 1979 and a wheelbase of 2650.
</p></section>
<section>
<h1 class="h1"> Key Specifications of Ferrari F8 Tributo: </h1>
<p class="para"><br>
    <img class="right2" src="image/features-vehicle-4.png" >
    <br>
</p>
