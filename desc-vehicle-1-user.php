...
<br>
  ...
  <br>
  <img class="right" src="image/vehicle-1.png" >
  <br>
  <h1 class="h"> 
    Ferrari Portofino
    <sub id="sub"></sub><br></h1>
...
<p class="para">The Ferrari Portofino has 1 Petrol Engine on offer. The Petrol engine is 3855 cc. 
  It is available with Automatic transmission.Depending upon the variant and fuel type the Portofino has a mileage of 9.0 kmpl. 
  The Portofino is a 4 seater 8 cylinder car and has length of 4586mm, width of 1938mm and a wheelbase of 2670mm.
</p></section>
<section>
<h1 class="h1"> Key Specifications of Ferrari Portofino: </h1>
<p class="para"><br>
    <img class="right2" src="image/features-vehicle-1.png" >
    <br>
</p>
