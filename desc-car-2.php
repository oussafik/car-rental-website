...
<header class="header">
    ...
    <nav class="navbar">
			...
			<a href="index1.php#vehicles">vehicles</a>
			<a href="index1.php#services">services</a>
			<a href="index1.php#featured">featured</a>
			<a href="index1.php#reviews">reviews</a>
...
<br>
  ...
  <br>
  <img class="right" src="image/car-2.png" >
  <br>
  <h1 class="h"> 
    Nissan Magnite
    <sub id="sub"></sub><br></h1>
...
<p class="para">The Nissan Magnite has 1 Petrol Engine on offer. The Petrol engine is 999 cc . 
    It is available with Manual & Automatic transmission.Depending upon the variant and fuel type the Magnite has a mileage of & 
    Ground clearance of Magnite is 205.
     The Magnite is a 5 seater 3 cylinder car and has length of 3994mm, width of 1758mm and a wheelbase of 2500mm..<br>
</p></section>
<section>
<h1 class="h1"> Key Specifications of Nissan Magnite: </h1>
<p class="para"><br>
    <img class="right2" src="image/features.png" >
    <br>
</p>
...
<br><h4>EXPENSE MANAGEMENT:</h4><p><br>
