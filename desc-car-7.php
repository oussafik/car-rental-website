...
<div class="login-form-container">
  ...
  <br>
  <img class="right" src="image/car-7.png" >
  <br>
  <h1 class="h"> 
    Kia Seltos
    <sub id="sub"></sub><br></h1>
...
<p class="para">The Kia Seltos has 1 Diesel Engine and 2 Petrol Engine on offer. 
  The Diesel engine is 1493 cc while the Petrol engine is 1497 cc and 1353 cc. 
  It is available with Manual & Automatic transmission.Depending upon the variant and fuel type the Seltos has a mileage of. 
  The Seltos is a 5 seater 4 cylinder car and has length of 4315, width of 1800 and a wheelbase of 2610.
</p></section>
<section>
<h1 class="h1"> Key Specifications of Kia Seltos: </h1>
<p class="para"><br>
    <img class="right2" src="image/features-car-7.png" >
    <br>
</p>
