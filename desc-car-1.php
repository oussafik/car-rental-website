    ...
    if (isset($btn)) {
      $con = mysqli_connect('localhost:3308', 'root', '', 'location');
        ...
        if ($n == 0) {
            ...
            header('location:desc-car-1-user.php');
        }
    }
?>
<!DOCTYPE html>
...
<br>
  ...
  <br>
  <img class="right" src="image/car-1.png" >
  <br>
  <h1 class="h"> 
    SL Roadster
    <sub id="sub"></sub><br></h1>
...
<p class="para">From its sharp diamond-block grille to its sporty cabin design, 
  the new Mercedes-Benz SL-Class thrills with its classic yet modern design. 
  You’ll enjoy up-to-the-minute features, such as: ATTENTION ASSIST, Active LED headlamps, Panorama roof, Side-mirror logo projectors, Sun-reflecting leather upholstery
</p></section>
<section>
<h1 class="h1"> Key Specifications of SL Roadster: </h1>
<p class="para"><br>
    <img class="right2" src="image/features-car-1.png" >
</p>
<p class="para"><br>
