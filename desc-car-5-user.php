...
<br>
  ...
  <br>
  <img class="right" src="image/car-5.png" >
  <br>
  <h1 class="h"> 
    Kia Sportage
    <sub id="sub"></sub><br></h1>
...
<p class="para">The Kia Sportage has 1 Diesel Engine and 2 Petrol Engine on offer. The Diesel engine is 1493 cc 
  while the Petrol engine is 1197 cc and 998 cc . It is available with Automatic & Manual transmission. 
  Depending upon the variant and fuel type the Sonet has a mileage of . 
  The Sportage is a 5 seater 4 cylinder car and has length of 3995, width of 1790 and a wheelbase of 2500.<br>
</p></section>
<section>
<h1 class="h1"> Key Specifications of Kia Sportage: </h1>
<p class="para"><br>
    <img class="right2" src="image/features-car-5.png" >
    <br>
</p>
