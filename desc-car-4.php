...
<br>
  ...
  <br>
  <img class="right" src="image/car-4.png" >
  <br>
  <h1 class="h"> 
    Audi Q5
    <sub id="sub"></sub><br></h1>
...
<p class="para">The Audi Q5 has 1 Petrol Engine on offer. 
  The Petrol engine is 1984 cc . It is available with Automatic & Manual transmission.Depending upon 
  the variant and fuel type the Q5 has a mileage of 13.47 kmpl . 
  The Q5 is a 5 seater 4 cylinder car and has length of 4682mm, width of 2140mm and a wheelbase of 2819mm.<br>
</p></section>
<section>
<h1 class="h1"> Key Specifications of Audi Q5: </h1>
<p class="para"><br>
    <img class="right2" src="image/features-car-4.png" >
    <br>
</p>
